...
void main() {
  group('Mods', () {
    ...
    test('^ operator toggles flags', () {
      ...
      final toggled = mods ^ const Mods.ctrl();
    ...
    test('^ operator sets flags that are absent', () {
      final toggled = const Mods.ctrl() ^ const Mods.alt();
    ...
    test('^ with same value produces none', () {
      final toggled = const Mods.ctrl() ^ const Mods.ctrl();
      expect(toggled.isEmpty, isTrue);
    });

    test('^ with none is identity', () {
      final toggled = const Mods.shift() ^ const Mods.none();
      expect(toggled, equals(const Mods.shift()));
    });
